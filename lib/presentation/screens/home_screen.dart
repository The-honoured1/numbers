...
class _HomeScreenState extends State<HomeScreen> {
  ...
  List<GameModel> _getGames() {
    final cw = GameModel(
      id: 'crossword',
      title: 'Math Cross',
      description: 'Cross-Equation Solver',
    ...
    return [
      GameModel(
        id: 'sudoku',
        title: 'Number Grid',
        description: 'Classic Sudoku Challenge',
        icon: Icons.grid_4x4_rounded,
        accentColor: NumbersColors.yellow,
        screen: const SudokuScreen(difficulty: 'Medium'),
      ),
      GameModel(
        id: '2048',
        title: '2048',
        description: 'Merge Tiles to Win',
        icon: Icons.dashboard_rounded,
        accentColor: NumbersColors.blue,
        screen: const Screen2048(),
      ),
      GameModel(
        id: 'math_puzzle',
        title: 'Math Puzzle',
        description: 'Quick Mental Math',
        icon: Icons.calculate_rounded,
        accentColor: NumbersColors.green,
        screen: const PuzzleScreen(),
      ),
      GameModel(
        id: 'sequence',
        title: 'Sequence',
        description: 'Find Missing Patterns',
        icon: Icons.trending_up_rounded,
        accentColor: NumbersColors.purple,
      ...
      GameModel(
        id: 'zen_ascend',
        title: 'Zen Ascend',
        description: 'Speed Ascending Tap',
        icon: Icons.keyboard_double_arrow_up_rounded,
        accentColor: NumbersColors.green,
        screen: const AscendScreen(),
      ),
      ...
      GameModel(
        ...
        screen: LevelSelectScreen(
          game: cw,
          screenBuilder: (l) => CrosswordScreen(initialLevel: l),
          maxUnlockedResolver: (s) => s.getHighScore('crossword_level'),
          totalLevels: 100,
        ),
      ),
      ...
      GameModel(
        ...
        screen: LevelSelectScreen(
          game: ms,
          screenBuilder: (l) => MinesweeperScreen(initialLevel: l + 1),
          maxUnlockedResolver: (s) => s.getHighScore('minesweeper_level') - 1,
          totalLevels: 500,
        ),
      ),
    ];
  ...
  Future<bool> _showExitConfirmation(BuildContext context) async {
    return await showDialog<bool>(
          ...
          builder: (context) => AlertDialog(
            ...
            content: Text(
              'Are you sure you want to exit the game? Your daily streak is waiting!',
              style: GoogleFonts.outfit(color: context.onSurface),
            ),
            actions: [
              TextButton(
                  ...
                  children: [
                    ...
                    GestureDetector(
                          onTap: () => Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => dailyGame.screen!,
                            ),
                          ),
                          child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: Text(
                                          storage.isDailyCompleted(dailyGame.id)
                                              ? 'REPLAY CHALLENGE'
                                              : 'PLAY NOW',
                                          style: GoogleFonts.outfit(
                                            fontSize: 15,
  ...
  Widget _buildStreakCard(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: context.shadow, blurRadius: 0, offset: Offset(4, 4)),
        ],
      ),
      child: Row(
        children: [
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'CHOOSE YOUR DAILY BRAIN WORKOUT',
                            style: GoogleFonts.outfit(
                              fontSize: 11,
                              fontWeight: FontWeight.w800,
                              letterSpacing: 1.5,
                    ...
                    _StatsButton(onPressed: onViewStats),
                  ],
                ),
              ),
            ),
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: context.border.withValues(alpha: 0.18),
                      width: 1.2,
                    ),
                  ),
                  child: const Icon(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              Text(
                'YOUR JOURNEY THROUGH THE NUMBERS',
                style: GoogleFonts.outfit(
                  fontSize: 10,
                  fontWeight: FontWeight.w800,
                  letterSpacing: 2,
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        _heroMiniStat(
                          'PLAY TIME',
                          StorageService.formatDuration(
                            storage.getTotalPlayTime(),
                          ),
                          context,
                        ),
                        Container(
              ...
              _SectionHeader(
                title: 'LAST 7 DAYS',
                subtitle: 'DAILY CHALLENGE COMPLETION',
              ),
              const SizedBox(height: 16),
              ...
              _SectionHeader(
                ...
                subtitle: 'TAPPING INTO YOUR DATA',
              ),
              const SizedBox(height: 16),
                    ...
                    : Center(
                        child: Text(
                          ...
                          style: GoogleFonts.outfit(
                            ...
                            color: isToday
                                ? NumbersColors.blue
                                : context.textFaint.withOpacity(0.5),
                          ),
                        ),
                      ),
              ),
              ...
              Row(
                ...
                children: [
                  ...
                  _miniStat(
                    context,
                    'PLAY TIME',
                    StorageService.formatDuration(time),
                    context.onSurface,
                  ),
                ],
              ),
